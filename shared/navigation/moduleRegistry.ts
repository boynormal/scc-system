...
export const MODULE_NAV_REGISTRY: ModuleNavNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        type: "link",
        key: "maintenance_master_data",
        href: "/maintenance/master-data",
        label: "maintenance_master_data",
        icon: "Database",
        permission: { resource: "settings", action: "read" },
        moduleId: "maintenance_master_data",
        order: 3,
        keywords: ["หมวดหมู่เครื่องจักร", "ประเภทงานซ่อม", "maintenance types", "categories", "ข้อมูลพื้นฐาน"],
        launcher: { departmentId: "work_management", capabilityId: "pm" },
      },
      {
        type: "link",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        moduleId: "hr_org",
        order: 1,
        keywords: ["org", "chart", "ผังองค์กร", "โครงสร้าง", "สายบังคับบัญชา", "ตำแหน่งว่าง"],
        launcher: { departmentId: "people", capabilityId: "org_chart" },
      },
      {
        type: "link",
        key: "hr_positions",
        ...
        label: "hr_positions",
        icon: "Workflow",
        permission: { resource: "hr_positions", action: "read" },
        moduleId: "hr_positions",
        order: 2,
        keywords: ["position", "ตำแหน่ง", "อัตรากำลัง", "หน้าที่ความรับผิดชอบ", "JD", "หัวหน้า"],
        launcher: { departmentId: "people", capabilityId: "positions" },
      },
      {
        type: "link",
        key: "hr_attendance",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: "settings_partners",
        icon: "Database",
        permission: { resource: "settings", action: "read" },
        moduleId: "settings_partners",
        order: 3,
        keywords: ["ซัพพลายเออร์", "ผู้ขาย", "vendor", "supplier", "คู่ค้า", "หน่วยนับ", "units", "master data", "ข้อมูลพื้นฐาน"],
        launcher: { departmentId: "configuration", capabilityId: "admin", isPrimary: true },
      },
      {
        type: "link",
        ...
        label: "settings_organization",
        icon: "Building2",
        permission: { resource: "settings", action: "read" },
        moduleId: "settings_organization",
        order: 4,
        keywords: ["แผนก", "ฝ่าย", "department", "โครงสร้าง", "master data", "ข้อมูลพื้นฐาน"],
        launcher: { departmentId: "configuration", capabilityId: "admin", isPrimary: true },
      },
    ],
  },
